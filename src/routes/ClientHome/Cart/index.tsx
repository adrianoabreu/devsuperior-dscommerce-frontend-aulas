...
export default function Cart() {
    ...
    */
    ...
    function handleDecreaseItem(productId : number){
        cartService.decreaseItem(productId);//diminui quantidade do item do carrinho no localStorage
        updateCart();
    }

    function updateCart(){
        const newCart = cartService.getCart();
        setCart(newCart);//Atualizando tela com carrinho limpo
    ...
    return (
        <main>
            <section id="cart-container-section" className="dsc-container">
                ...
                {/*condicional para mostrar conteúdo do carrinho quando tiver pelo menos um item,
                  ou mensagem "Seu carrinho está vazio" caso não possua nenhum item no carrinho. */
                    cart.items.length === 0
                        ? (
                            <div>
